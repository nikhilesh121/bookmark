...
export default async function AnimePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="flex w-full flex-col">
      <section className="bg-gradient-to-r from-pink-500 to-rose-500 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white">Anime</h1>
          </div>
          <p className="text-white/80 text-lg max-w-xl">
            Discover amazing anime series and movies. Stream your favorites instantly!
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="text-sm text-zinc-500">
            ...
            <span className="font-semibold text-zinc-700">{data.total}</span> anime
          </p>
          <p className="text-sm text-zinc-500">
        ...
        {data.items.length === 0 && (
          <div className="text-center py-16 bg-white rounded-2xl border border-zinc-200">
            ...
            <h3 className="text-lg font-semibold text-zinc-700 mb-2">No anime found</h3>
          ...
          <div className="mt-8 flex items-center justify-center gap-2">
            {data.page > 1 && (
              <Link
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border-2 border-zinc-200 bg-white font-medium text-sm hover:border-pink-300 hover:text-pink-600 transition-colors"
              >
